module MongoDb exposing (CollectionUrl(..), MongoDb, collectionUrl, createCollection, deleteCollection, filterCollection, getCollection, getString, listDocuments, mongoDbDecoder, putCollection)

import BaseModel exposing (Collection, collectionDecoder)
import Http exposing (Error)
import HttpBuilder exposing (..)
import Json.Decode as Json exposing (Decoder, at, field, map, maybe, oneOf, succeed)
...
{-| List all documents in collection. **It ignores items that cannot be parsed.**
-}
